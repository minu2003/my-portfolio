...
export default function LandingPage(){
    ...
    return(
        <div className="flex flex-col lg:flex-row min-h-screen max-w-7xl mx-auto gap-6 lg:gap-10 justify-center items-center px-4 lg:px-8 pt-16 sm:pt-20 md:pt-24 lg:pt-32">

            {/* Right Section - Desktop & Large Tablets */}
            <div className="w-full lg:w-1/2 justify-center lg:justify-end 2xl:mr-17 hidden lg:flex max-w-2xl mx-auto items-start order-1 lg:order-1 mt-6">
            ...
            <div className="block 2xl:hidden max-w-xl mx-auto text-center">
            ...
            <h1 className="hidden 2xl:block text-6xl mb-3 font-bold text-center max-w-xl mx-auto">Hello,</h1>
            <h1 className="hidden 2xl:block text-6xl mb-3 font-bold text-center max-w-xl mx-auto">I&apos;m Minuri Viranga</h1>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-3xl text-gray-500 text-center max-w-xl mx-auto">Web & Mobile App Developer</h2>
            
            {/* Mobile & iPad image under subtitle */}
            <div className="block lg:hidden w-full mt-8 sm:mt-10 md:mt-12 px-6 sm:px-8 md:px-12">
            ...
            {/* Projects Card */}
            <div className="w-full sm:max-w-xs lg:max-w-xs 2xl:w-70 bg-gray-800 rounded-2xl p-4 lg:p-5 shadow-2xl border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-3xl mb-0 mx-auto">
          ...
          >
            ...
            {/* social media */}
            <div className="flex gap-2 lg:gap-3 mt-6 sm:mt-8 md:mt-10 lg:mt-4 justify-center flex-wrap max-w-xl mx-auto">
                {/* LinkedIn */}
                ...
                <a href="https://www.instagram.com/minu_viranga?igsh=ZWg2NDRpamEyeHdi" target="_blank" rel="noopener noreferrer"
                   className="w-12 h-12 lg:w-14 lg:h-14 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-all duration-300 transform hover:scale-105 shadow-lg border border-gray-700 hover:border-gray-600">
                    <svg className="w-6 h-6 lg:w-7 lg:h-7 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
