        ...
        <section id="about-me" className="relative py-16 sm:py-20 px-4 sm:px-6" ref={ref}>
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                ...
                >
                    ...
                    <div className="w-14 h-[2px] bg-gradient-to-r from-transparent via-white/50 to-transparent lg:from-white/50 lg:to-transparent mb-8" />

                    <p className="text-base sm:text-[1.05rem] text-white/55 leading-[1.85] max-w-2xl">
                    ...
                    <p className="text-base sm:text-[1.05rem] text-white/55 leading-[1.85] mt-5 max-w-2xl">
